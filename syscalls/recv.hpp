...
struct RecvSyscall : Syscall<RecvSyscall,
                             SYS_recvfrom,   // same syscall number on x86_64
                             IntArg,
                             PtrArg,
                             SizeArg,
                             IntArg>
{
    static const char *name() { return "recv"; }
...
static Register<RecvSyscall> reg_recv;